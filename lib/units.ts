export const categories: any = {
  length: {
    ...
    units: {
      ...
      feet: { name: { en: 'Feet', tr: 'Fit', es: 'Pies', hi: 'अधirोहण' }, ratio: 3.28084 },
      mile: { name: { en: 'Miles', tr: 'Mil', es: 'Millas', hi: 'मील' }, ratio: 0.000621371 }
    }
  },
  weight: {
    name: { en: 'Weight', tr: 'Ağırlık', es: 'Peso', hi: 'वजन' },
    icon: '⚖️',
    units: {
  ...
  volume: {
    ...
    units: {
      ...
      gal: { name: { en: 'Gallons', tr: 'Galon', es: 'Galones', hi: 'गैलन' }, ratio: 0.264172 }
    }
  }
};
