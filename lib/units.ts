...
export const categories: any = {
  ...
  time: {
    name: { en: 'Time ⏱️', tr: 'Zaman ⏱️', es: 'Tiempo ⏱️', hi: 'समय ⏱️' },
    units: {
  ...
  volume: {
    ...
    units: {
      ...
      gal: { name: { en: 'Gallons (US)', tr: 'Galon', es: 'Galones', hi: 'गैलन' }, ratio: 0.264172 }
    }
  },
  speed: {
    ...
    units: {
      ...
      knot: { name: { en: 'Knots', tr: 'Düğüm (Knot)', es: 'Nudos', hi: 'नॉट' }, ratio: 1.94384 }
    }
  },
  data: {
    ...
    units: {
      ...
      kb: { name: { en: 'Kilobytes', tr: 'Kilobayt', es: 'Kilobytes', hi: 'किलोबाइट' }, ratio: 1 / 1024 },
      ...
      tb: { name: { en: 'Terabytes', tr: 'Terabayt', es: 'Terabytes', hi: 'टेराबाइट' }, ratio: 1 / (1024 * 1024 * 1024 * 1024) }
    }
  }
};

export const universalConvert = (val: number, from: string, to: string, catKey: string) => {
